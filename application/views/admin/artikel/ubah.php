                    ...
                    <div class="card-body">
                        ...
                        <form class="row" method="post" enctype="multipart/form-data">
                            <div class="col-md-8 mb-3">
                                ...
                                <input type="text" class="form-control" id="title" name="title" placeholder="Judul Kegiatan" value="<?= $oneData->title ?>" required>
                                <?= form_error('title', '<small class="text-danger pl-3">', '</small>'); ?>
                            </div>
                            <div class="col-md-4 mb-3">
                                <label for="kategori_id">Kategori Artikel</label>
                                <select name="kategori_id" id="kategori_id" class="form-select" required>
                                    <option value="<?= $oneData->kategori_id ?>" hidden><?= $oneData->kategori ?></option>
                            ...
                            <img src="<?= base_url('assets/img/blog/') . $oneData->image ?>" class="mb-4" alt="">

                            <div class="mb-3">
                                <label for="content">Konten Artikel</label>
                                <textarea class="tinymce-editor" name="content"><?= $oneData->content ?></textarea>
